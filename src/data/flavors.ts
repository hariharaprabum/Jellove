...
export const flavors: Flavor[] = [
  {
    ...
    collection: 'nature',
    heroImage: '/images/nature/mango.webp',
    color: 'bg-amber-50',
    accentHex: '#E8A000',
  ...
  },
  {
    ...
    collection: 'nature',
    heroImage: '/images/nature/strawberry.webp',
    color: 'bg-rose-50',
    accentHex: '#E8234A',
  ...
  },
  {
    ...
    collection: 'nature',
    heroImage: '/images/nature/chikoo.webp',
    color: 'bg-orange-50',
    accentHex: '#A0622A',
    origin: 'South India',
  ...
  },
  {
    ...
    collection: 'nature',
    heroImage: '/images/nature/jackfruit.webp',
    color: 'bg-yellow-50',
    accentHex: '#C8A000',
  ...
  },
  {
    ...
    collection: 'nature',
    heroImage: '/images/nature/tender-coconut.webp',
    color: 'bg-emerald-50',
    accentHex: '#2D8A50',
    origin: 'Kerala Coast',
  ...
  },
  {
    ...
    collection: 'world',
    heroImage: '/images/world/honeycomb.webp',
    color: 'bg-amber-50',
    accentHex: '#D4800A',
  ...
  },
  {
    ...
    collection: 'world',
    heroImage: '/images/world/matcha.webp',
    color: 'bg-green-50',
    accentHex: '#3D7A2A',
    origin: 'Uji, Japan',
  ...
  },
  {
    ...
    collection: 'world',
    heroImage: '/images/world/cheesecake.webp',
    color: 'bg-purple-50',
    accentHex: '#7A3A8A',
    origin: 'New York, USA',
  ...
  },
  {
    ...
    collection: 'world',
    heroImage: '/images/world/brown-butter-vanilla.webp',
    color: 'bg-amber-50',
    accentHex: '#8A5A1A',
    origin: 'Paris, France',
